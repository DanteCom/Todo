...
class NutritionGoalBottomSheet extends StatelessWidget {
  const NutritionGoalBottomSheet({super.key, required this.goal});
  ...
  Widget build(BuildContext context) {
    ...
    final nutrition = goal.nutrition!;
    return Container(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            state.capitalize(nutrition.category.title),
                      ...
                      children: [
                        Wrap(
                          ...
                          children: List.generate(
                            nutrition.weeks.length,
                            (index) {
                              final week = nutrition.weeks[index];
                              return Container(
                                width: 100.w / 7 - 12,
                                padding:
                ...
                children: [
                  ...
                  Expanded(
                    child: CupertinoButton(
                      onPressed: () {
                        context.pop();
                        GoalModel.delete(goal, GoalCategory.nutrition);
                      },
                      color: AppColors.white,
                      padding: const EdgeInsets.symmetric(vertical: 12),
                      borderRadius: BorderRadius.circular(20),
