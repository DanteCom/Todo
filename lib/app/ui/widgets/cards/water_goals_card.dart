...
class WaterGoalsCard extends StatelessWidget {
  const WaterGoalsCard({
    super.key,
    required this.goal,
  });
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        state.capitalize(water.category.title),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(8),
                    AppRichText(title: water.ml, subtitle: 'ml'),
                  ],
                ),
              ),
            ],
          ...
          CupertinoButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                ...
                builder: (context) => WaterGoalBottomSheet(goal: goal),
              );
            },
